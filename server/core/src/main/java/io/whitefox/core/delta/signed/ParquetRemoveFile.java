...
public class ParquetRemoveFile implements ParquetFileAction {
    /**
    ...
    public static ParquetRemoveFile signed(ParquetRemoveFileToBeSigned f,
                                           URI signedUrl,
                                           Optional<Long> expirationTimestamp,
                                           String newId) {
        return new ParquetRemoveFile(
