...
public class NullTypeException extends PredicateException {
    ...
    final private BaseOp leftChild;
    final private BaseOp rightChild;
    ...
    public String getMessage() {
        ...
        return "Comparison with a null value is not supported: " + leftChild.getClass() + " and " + rightChild.getClass();
    }
}
