...
public class TableV1ApiImplTest {
    ...
    public static void setup() {
        ...
        QuarkusMock.installMockForType(Clock.fixed(Instant.ofEpochMilli(0L), ZoneId.of("UTC")), Clock.class);
    }
    ...
    public void createFirstDeltaTable() {
        ...
        var tableObj = createTableObj("deltaTable", new InternalTable.DeltaTableProperties("file://some-path"), true);
    ...
    public void createFirstIcebergTable() {
        ...
        var tableObj = createTableObj("icebergTable", new InternalTable.IcebergTableProperties("db", "icebergTable"), true);
    ...
    public void failToCreateExistingTables() {
        var tableObj1 = createTableObj("icebergTable", new InternalTable.IcebergTableProperties("db", "icebergTable"), true);
        createTableAction(tableObj1, "provider2", objectMapper)
                .statusCode(409);
        var tableObj2 = createTableObj("deltaTable", new InternalTable.DeltaTableProperties("file://some-path"), true);
        createTableAction(tableObj2, "provider1", objectMapper)
                .statusCode(409);
    }
    ...
    public void failToCreateWhenProviderDoesNotExist() {
        var tableObj1 = createTableObj("icebergTable", new InternalTable.IcebergTableProperties("db", "icebergTable"), true);
        createTableAction(tableObj1, "provider3", objectMapper)
                .statusCode(404);
    }
    ...
    public void describeExistingTable() {
        ...
        given()
                .when()
                .filter(filter)
                .get("/whitefox-api/v1/providers/{providerName}/tables/{tableName}", providerName, tableName)
                .then()
                .statusCode(200)
                        .body("providerName", is("provider2"))
                .body("name", is("icebergTable"))
    ...
    public static ValidatableResponse createTableAction(CreateTableInput createTableInput,
                                                        String providerName,
    ...
    private static CreateTableInput createTableObj(String tableName, InternalTable.InternalTableProperties properties, boolean skipValidation) {
