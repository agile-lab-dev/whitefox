...
public class CreateInternalTable {
    ...
    public CreateInternalTable(String name, Optional<String> comment, Boolean skipValidation, InternalTable.InternalTableProperties properties) {
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(name, that.name) && Objects.equals(comment, that.comment) && Objects.equals(skipValidation, that.skipValidation) && Objects.equals(properties, that.properties);
    }
