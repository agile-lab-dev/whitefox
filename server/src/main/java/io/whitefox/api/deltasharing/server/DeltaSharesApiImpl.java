...
import io.whitefox.api.deltasharing.mapper.TableMetadataMapper;
    ...
    return wrapExceptions(
        () -> optionalToNotFound(
            ...
            m -> optionalToNotFound(
                ...
                v -> Response.ok(
                        serializer.serialize(tableMetadataMapper.toTableResponseMetadata(
                            new DeltaTableMetadata(v, m))),
                        ndjsonMediaType)
