...
dependencies {
    constraints {
        ...
        api("io.delta:delta-kernel-api:3.1.0")
        api("io.delta:delta-kernel-defaults:3.1.0")
        ...
        api("software.amazon.awssdk:s3:2.25.44")
        api("software.amazon.awssdk:s3-transfer-manager:2.25.44")
        api("software.amazon.awssdk:utils:2.25.44")
