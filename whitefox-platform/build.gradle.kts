...
dependencies {
    constraints {
        ...
        api("org.eclipse.microprofile.openapi:microprofile-openapi-api:3.1.2")
        ...
        api("software.amazon.awssdk:glue:2.25.60")
        api("software.amazon.awssdk:sts:2.25.60")
        api("software.amazon.awssdk:s3:2.25.60")
