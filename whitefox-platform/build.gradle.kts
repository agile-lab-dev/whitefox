...
dependencies {
    constraints {
        ...
        api("software.amazon.awssdk:glue:2.26.12")
        api("software.amazon.awssdk:sts:2.26.12")
        api("software.amazon.awssdk:s3:2.26.12")
        api("software.amazon.awssdk:s3-transfer-manager:2.26.12")
        api("software.amazon.awssdk:utils:2.26.12")
        api("software.amazon.awssdk:url-connection-client:2.26.12")
