...
dependencies {
    constraints {
        ...
        api("software.amazon.awssdk:bom:2.28.19")
        api("software.amazon.awssdk:glue:2.28.19")
        api("software.amazon.awssdk:sts:2.28.19")
        api("software.amazon.awssdk:s3:2.28.19")
        api("software.amazon.awssdk:s3-transfer-manager:2.28.19")
        api("software.amazon.awssdk:utils:2.28.19")
        api("software.amazon.awssdk:url-connection-client:2.28.19")
