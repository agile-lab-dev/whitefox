...
dependencies {
    constraints {
        ...
        api("software.amazon.awssdk:s3-transfer-manager:2.25.50")
        api("software.amazon.awssdk:utils:2.25.50")
        api("software.amazon.awssdk:url-connection-client:2.25.50")
