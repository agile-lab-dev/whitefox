...
public class Testo {
    ...
    public void testHelloEndpoint() throws ApiException, io.delta.sharing.api.utils.ApiException {
        ...
        Metastore glueMetastoreDefault = metastoreApi.createMetastore(
                new CreateMetastore()
        ...
        tableApi.addTableToSchema(share.getName(),share.getSchemas().get(0), new TableReference()
                .name(table.getName())
                .providerName(table.getProviderName()));
